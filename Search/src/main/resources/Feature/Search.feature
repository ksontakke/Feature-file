...
Scenario Outline: User wants to search for particular Educator/lesson/course
Given User is on Unacademy Home Page
When User enters <Educator>,<lesson> and <course>
Then User navigates to respective pages
Examples:
|Educator					|lesson			|course	|
|Sahil Khandelwal	|Chemistry	|SSC		|
...
Scenario: User wants see Enrolled and saved course content
Given User is on a Course page
